    ...
    >
      {theme === 'dark' ? (
        <svg
          ...
          fill="currentColor"
        >
          <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 00-10.586 10.586A8.001 8.001 0 0017.293 13.293z" />
        </svg>
      ) : (
        <svg
          xmlns="http://www.w3.org/2000/svg"
